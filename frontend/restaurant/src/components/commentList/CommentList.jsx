          ...
          {currentComments.map((comment, index) => (
            <div className="card mt-3 card-review-restaurant" key={index}>
              <div className="card-body">
                <div className="row">
                  <div className="col-sm-12 col-md-1 d-none d-sm-block">
                    {/* La imagen solo se mostrará en dispositivos mayores a xs */}
                    ...
                    <div className="media">
                      <div className="media-body">
                        <div className="row">
                          ...
                          <p className="card-text col-md-6 d-flex justify-content-md-end">
                            Fecha: {comment.date}
                          </p>
                        </div>
